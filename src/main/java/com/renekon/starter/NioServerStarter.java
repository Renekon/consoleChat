...
class NioServerStarter {
    ...
    private static final int CONNECT_QUEUE_CAPACITY = 10;
    private static final int CONNECT_EVET_QUEUE_CAPACITY = 100;
    private static final int PROCESSOR_THREADS_NUM = 8;

    public static void main(String[] args) throws IOException {
        ConnectionManager connectionManager = new NioConnectionManager(new InetSocketAddress(PORT));
        Server server = new Server(connectionManager, CONNECT_QUEUE_CAPACITY, CONNECT_EVET_QUEUE_CAPACITY);
